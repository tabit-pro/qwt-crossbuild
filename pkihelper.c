...
int __cdecl main(int argc, char** argv)
{
	...
	int i;
        ...
        safe_strcat(cat_path, sizeof(cat_path), "qvmini.sys");
        SelfSignFile(cat_path, "CN=QUBES-AUTOGENERATED-CERT-qvmini");

        safe_strcpy(cat_path, sizeof(cat_path), drv_path);
        safe_strcat(cat_path, sizeof(cat_path), "\\");
        safe_strcat(cat_path, sizeof(cat_path), "qvgdi.dll");
        SelfSignFile(cat_path, "CN=QUBES-AUTOGENERATED-CERT-qvgdi");
